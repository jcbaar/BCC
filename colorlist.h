...
public:
	...
	inline int *GetIndexArray() { return &m_nIndex[ 0 ]; }
...
protected:
	...
	LPPARSER	m_pParser;
	static int	m_nColors[    CARR_SIZEOF + 1 ];
	static int	m_nIndex[     CARR_SIZEOF + 1 ];
	static DWORD	m_dwFlags[    CARR_SIZEOF + 1 ];
	static COLORREF	m_crDefaults[ CARR_SIZEOF + 1 ];
};