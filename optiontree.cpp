...
//	AddOption( ClsString( MAKEINTRESOURCE( IDS_HIGHLIGHT_LINE )));
	...
	AddOption( ClsString( MAKEINTRESOURCE( IDS_TABS2SPACES )));
	AddOption( ClsString( MAKEINTRESOURCE( IDS_COLORCOLUMNOVERFLOW )));
	return TRUE;
}
...
//	SetOption( ClsString( MAKEINTRESOURCE( IDS_HIGHLIGHT_LINE )), &lpp->bHighlightCurrentLine );
	...
	SetOption( ClsString( MAKEINTRESOURCE( IDS_TABS2SPACES )), &lpp->bSaveTabsAsSpaces );
	SetOption( ClsString( MAKEINTRESOURCE( IDS_COLORCOLUMNOVERFLOW )), &lpp->bColorColumnMarkerOverflow );
	return TRUE;
}
